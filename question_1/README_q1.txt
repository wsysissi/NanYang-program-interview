...
equal to the serial number of that row, the matrix generated in code_question_1.py 
is also of this form. however, it can be replaced with other matrices in other cases.

But the time complexity of the computation way in the code_question_1.py is so large 
