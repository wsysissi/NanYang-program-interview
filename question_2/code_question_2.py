...
for hang in range(0,len(matrix)):
    for lie in range(0,len(matrix[hang])):
        if matrix[hang][lie].val == 1 and matrix[hang][lie].label == None:
            total_label +=1
